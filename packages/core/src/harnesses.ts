...
function isRun(value: unknown): value is HarnessRun {
  ...
  const operationKinds = ["block_attempt", "dependency_decision", "route_selection", "prompt_delivery", "session_binding", "timer_create", "timer_fire", "child_registration", "task_create", "tool_command", "merge", "terminal_outcome"];
