...
export function GitToolbarActions({ selectedCount, operationRunning, pushing, fetching, rollingBack, upstream, onRollbackSelected, onUndoLastCommit, onPush, onPull, onFetch, onRefresh }: {
