  ...
  return <div className="ide-shell"><ModalFocusManager />
    ...
    <div className="workspace-row">
      ...
      <nav className="tool-stripe" aria-label="Left tool windows">
        ...
        <button className={`tool-stripe-button ${leftPanels.harness ? "active" : ""}`} title={leftPanels.harness ? "Hide Harness" : "Show Harness"} onClick={() => setLeftPanels((current) => { if (!current.harness) void refreshHarnesses(); return { ...current, harness: !current.harness }; })}><Workflow size={15} /><span>Harness</span></button>
      </nav>
      ...
      <nav className="tool-stripe" aria-label="Left tool windows">
        ...
        <button className={`tool-stripe-button ${classicSideView === "harness" ? "active" : ""}`} title="Harness" onClick={() => { selectClassicSideView("harness"); void refreshHarnesses(); }}><Workflow size={15} /><span>Harness</span></button>
