...
export type HarnessBlock = { id: string; type: "prompt" | "task"; label: string; prompt: string; inputSchema?: HarnessDataSchema; outputSchema?: HarnessDataSchema; provider?: AiProvider; model?: string; agent?: AgentFileReference; watchdog?: boolean; join?: "all" | "any"; routing?: "all" | "ai"; position: { x: number; y: number } };
...
export type HarnessValidationIssue = { code: "empty" | "duplicate-id" | "duplicate-edge-id" | "missing-endpoint" | "self-edge" | "duplicate-edge" | "cycle" | "route-label" | "empty-label" | "empty-prompt" | "unknown-template" | "missing-template-block" | "invalid-loop" | "invalid-schema"; message: string; blockId?: string; edgeId?: string };
